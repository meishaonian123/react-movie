...
export default class MovieItem extends React.Component{
  ...
  render(){
    return <div className = {styles.box} onClick={this.goDetail}>
       {/* <img src={this.props.images.small} className={styles.img}></img> */}
       <img src={this.props.images.small.replace('img9.doubanio.com', 'img9.doubanio.com')} className={styles.img}></img>
